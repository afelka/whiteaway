...
function(input, output) {
  ...
  output$table2 <- DT::renderDataTable({
    ...
    data_with_price_group <- data %>%
                               ...
                               breaks = c(-Inf, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000,
                                          5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000, 
                                          11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000, 20000, Inf),
                               labels = c("<500", "500-1000", "1000-1500", "1500-2000", "2000-2500", "2500-3000",
                                          ...
                                          "12000-13000","13000-14000","14000-15000","15000-16000",
